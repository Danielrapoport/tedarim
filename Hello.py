...
relax, energy, custom = st.tabs(['Relax', 'Energy', 'Custom'])
with relax:
    st.markdown("### 0.5hz - Strong Relax")
    genWave(55,55.5)
    st.divider()
    st.markdown("### 1hz - Strong Relax")
    genWave(55,56)
    st.divider()
    st.markdown("### 4hz - Relax")
    genWave(55,59)
    st.divider()
    st.markdown("### 6hz -  Relax")
    genWave(55,61)
with energy:
    st.markdown("### 60hz - Energy")
    genWave(216,276)
    st.divider()
    st.markdown("### 40hz - Energy")
    genWave(216,256)
    st.divider()
    st.markdown("### 32hz - Energy")
    genWave(216,248)
